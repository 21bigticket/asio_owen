...
inline constexpr std::string_view kMetaKey =
    "asio_owen:config:history:meta";
inline constexpr std::string_view kIndexKey =
    "asio_owen:config:history:index";
inline constexpr std::string_view kSnapshotPrefix =
    "asio_owen:config:history:";
inline constexpr std::string_view kSnapshotStagingKey =
    "asio_owen:config:history:staging";
