...
struct ConfigHistoryConfig {
    ...
    size_t warn_snapshot_bytes = static_cast<size_t>(256) * 1024;
    size_t max_snapshot_bytes = static_cast<size_t>(512) * 1024;
    size_t warn_file_bytes = static_cast<size_t>(64) * 1024;
    size_t max_file_bytes = static_cast<size_t>(128) * 1024;
    ...
    size_t max_diff_response_bytes = static_cast<size_t>(2) * 1024 * 1024;
